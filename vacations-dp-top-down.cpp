...
int megold(int nap_ind, int elozo_napi_aktivitas=0){
	...
	// VALTOZAS a brute-forcehoz kepest
	// ha mar kiszamoltuk, akkor ne szamolgassunk meg egyszer
	if(dp[nap_ind][elozo_napi_aktivitas] != -1) return dp[nap_ind][elozo_napi_aktivitas];
	...
	// VALTOZAS a brute-forcehoz kepest
	// elmentjuk, amit mar kiszamoltunk
...
int main() {
	...
	// VALTOZAS a brute-forcehoz kepest
	// n, 3 dimenzioju, mert ezzel lefedjuk az osszes valid megold parametert
